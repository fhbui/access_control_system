...
#define   RC522_CS_Enable()         HAL_GPIO_WritePin(RC522_CS_PORT, RC522_CS_PIN ,0)
#define   RC522_CS_Disable()        HAL_GPIO_WritePin ( RC522_CS_PORT, RC522_CS_PIN,1)

#define   RC522_Reset_Enable()      HAL_GPIO_WritePin( RC522_Reset_PORT, RC522_Reset_PIN,0)
#define   RC522_Reset_Disable()     HAL_GPIO_WritePin( RC522_Reset_PORT, RC522_Reset_PIN,1)

//#define   RC522_SCK_0()             HAL_GPIO_WritePin( RC522_SCK_PORT, RC522_SCK_PIN,0)
//#define   RC522_SCK_1()             HAL_GPIO_WritePin( RC522_SCK_PORT, RC522_SCK_PIN,1)
// 
//#define   RC522_MOSI_0()            HAL_GPIO_WritePin(RC522_MOSI_PORT, RC522_MOSI_PIN,0)
//#define   RC522_MOSI_1()            HAL_GPIO_WritePin(RC522_MOSI_PORT, RC522_MOSI_PIN,1)

//#define   RC522_MISO_GET()          HAL_GPIO_ReadPin(RC522_MISO_PORT, RC522_MISO_PIN)
